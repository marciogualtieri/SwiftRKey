...
```{r, eval = FALSE}
model <- readRDS(mod, "./data/model.rds")
```

That's how we're going to load our model in the ShinyApp.
...
We are going to evaluate our model by calculating the model's perplexity.
